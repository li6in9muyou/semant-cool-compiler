...
CLASS= cs143
CLASSDIR= ../..
LIB= -L/usr/pubsw/lib -lpthread -ldl
AR= gar
ARCHIVE_NEW= -cr
RANLIB= gar -qs
...
LI6QSRC= semant-program.cc semant-class.cc semant-attr.cc semant-method.cc loguru.cc semant-error-utility.cc semant-formal.cc semant-checks.cc semant-utility.cc
...
CC=g++
CFLAGS=-g -std=c++17 -Wall -Wno-unused -Wno-write-strings -Wno-deprecated ${CPPINCLUDE} -DDEBUG
FLEX=flex ${FFLAGS}
BISON= bison ${BFLAGS}
